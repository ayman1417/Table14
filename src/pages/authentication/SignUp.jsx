...
import { User } from '../../helper/User.module';
...
export default function SignUp({ goLogin, goSignUp, animate }) {
            ...
            <div className="  min-w-2/3   ">
                ...
                <div className="text-center ">
                    <h1 className="sm:text-3xl text-2xl font-bold text-gray-800">
                        Get started with <span className="text-main">Table14</span>
                    </h1>

                    <p className="text-gray-500 mt-2 text-xs sm:text-sm mb-3">
                        Fresh recipes, Simple cooking, All in one place.
                    </p>
                </div>
